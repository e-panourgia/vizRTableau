...
# Step 9: Save
ggsave("figures/plot_1_greece_vs_top_subjects_diff.png", plot = p1, width = 10, height = 6, dpi = 300, bg = "white")
cat("✅ Plot 1 saved to: figures/plot_1_greece_vs_top_subjects_diff.png\n")
...
# Save final version
ggsave("figures/plot_2_greece_filtered_glcm_boxplots.png", plot = p2, width = 12, height = 5, dpi = 300, bg = "white")
cat("✅ Plot 2 saved to: figures/plot_2_greece_filtered_glcm_boxplots.png\n")
# End Plot 2 : ================================================================
...
ggsave("figures/plot_3_glcm_plot.png", plot = p3, width = 10, height = 6, dpi = 320, bg = "white")
cat("✅ Plot 3 saved to: figures/plot_3_glcm_plot.png\n")
...
# Step 8: Save
ggsave("figures/plot_4_gendered_subject_scores_pink_blue_grouped_gender.png",
       plot = p_gendered, width = 10, height = 6, dpi = 300, bg = "white")
cat("✅ Plot 4 saved to: figures/plot_4_gendered_subject_scores_pink_blue_grouped_gender.png\n")
...
ggsave("figures/plot_5_glcm_vs_academic_gender_greece_dist_legend.png", g, width = 13, height = 6, dpi = 300, bg = "white")
cat("✅ Plot 5 saved to: figures/plot_5_glcm_vs_academic_gender_greece_dist_legend.png\n")
# End Plot 5 : ================================================================
